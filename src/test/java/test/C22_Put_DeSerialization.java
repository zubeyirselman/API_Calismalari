...
public class C22_Put_DeSerialization extends JsonPlaceHolderBaseURL {
    ...
    body’ ye sahip bir PUT request yolladigimizda donen response’ in
    ...
    public void put01(){
        ...
        // response' i HashMap formatina donusturuyoruz ve kullanabilmek icin obje olarak kaydediyoruz.
